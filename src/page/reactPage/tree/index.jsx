...
function Tree() {
  ...
  useEffect(() => {
    fetchApi(
      `${baseUrl}/mock/9a0b75972e6f3de5f1aebeb764372e80/redux/api/dimension`
    )
      .then((data) => {
        setData(data)
      })
          ...
          return (
            <li key={item.id}>
              ...
              >
                ...
                >
                  {!item.fold
                    ? item.children && <CaretDownOutlined />
                    : item.children && <CaretRightOutlined />}
                  {item.name}
                </div>
              </div>
              {item.children && (
            ...
            <li key={item.id}>
              ...
              >
                ...
                <div
                  ...
                  title={item.name}
                >
                  {!item.fold ? <CaretDownOutlined /> : <CaretRightOutlined />}
                  {item.name}
                </div>
              </div>
              {item.children && (
